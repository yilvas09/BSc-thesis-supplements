...
%  This code is for plotting systematic risk loading of firms under 
%  different numbers of active firms in the industry as well as the perfect
%  competition case. It produces Figure 7 in the paper.

%  See plot_beta.m for original version
clear, close all
addpath('./auxilaries')
addpath('./figures')
...
for k = 1:length(plot_n)
    ...
    [V,Vprime] = MRV_ComputeFirmValue(omg,B_1ht,B_2,prm);
...
xlabel('\omega')
ylabel('\beta(\omega; n)')
% print('./figures/beta_MRV_3_6_10_Inf','-dpng','-r600')
